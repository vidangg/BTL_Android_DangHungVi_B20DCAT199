...
import com.example.vidang199.databinding.ActivitySignupBinding;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                           ...
                           sharedPreferences = getSharedPreferences("SavedToken",MODE_PRIVATE);
                           String tokenInMain =  sharedPreferences.getString("ntoken","mynull");
                            Log.d("SharedPreferences", "Token value: " + tokenInMain);
                           userModel.setToken(tokenInMain);

                           firebaseDatabase.getReference().child("Users").child(id2).setValue(userModel);
                           Intent intent = new Intent(SignupActivity.this,MainActivity.class);
                           startActivity(intent);
